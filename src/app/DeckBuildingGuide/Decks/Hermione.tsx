  ...
  return (
    <>
      ...
      <Typography variant='h5'>
        ...
        However, we will discuss the two most popular hermy decks, the Hermy Thunderstorm, and the Hermy Firework/Whizbang.<br />
        ...
        Ron as the second companion, or Hermy.<br />
        Hagrid as the third.<br /><br />
